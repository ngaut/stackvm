...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('evaluation_status', sa.Enum('NOT_EVALUATED', 'WAITING_FOR_EVALUATION', 'APPROVED', 'REJECTED', name='evaluation_status'), server_default='NOT_EVALUATED', nullable=True, comment='The evaluation status of the task by the LLM.'),
    sa.Column('evaluation_reason', sa.Text(), nullable=True, comment='Reason for rejection if the task is not approved.'),
    sa.Column('human_evaluation_status', sa.Enum('NOT_EVALUATED', 'WAITING_FOR_EVALUATION', 'APPROVED', 'REJECTED', name='human_evaluation_status'), server_default='NOT_EVALUATED', nullable=True, comment='The evaluation status of the task by the Human.'),
