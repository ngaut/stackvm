...
Revision ID: f4d62a027b97
Revises: 
Create Date: 2025-01-21 11:10:08.304050
...
def upgrade() -> None:
    ...
    op.create_index('idx_label_namespace', 'labels', ['namespace_name'], unique=False)
    op.create_index('idx_label_parent', 'labels', ['parent_id'], unique=False)
    ...
    op.create_index('idx_task_label', 'tasks', ['label_id'], unique=False)
    op.create_index('idx_task_namespace', 'tasks', ['namespace_name'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_task_namespace', table_name='tasks')
    op.drop_index('idx_task_label', table_name='tasks')
    op.drop_table('tasks')
    op.drop_index(op.f('ix_labels_namespace_name'), table_name='labels')
    op.drop_index(op.f('ix_labels_id'), table_name='labels')
    op.drop_index('idx_label_parent', table_name='labels')
    op.drop_index('idx_label_namespace', table_name='labels')
